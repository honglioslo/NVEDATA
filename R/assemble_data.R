...
load_data_mean <- function(path_met, path_runoff, regine_main, time_vec, file_type) {
...
load_data_elev <- function(path_met, path_runoff, regine_main, time_vec, file_type) {
