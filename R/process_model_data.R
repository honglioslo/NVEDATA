...
#' @param file_type Read from netcdf or bil files ("ncdf" or "bil")
...
#' file_type <- "ncdf"
#' write_model_data(path_met, path_runoff, path_model_data, regine_main, time_vec, file_type)
#' @export

write_model_data <- function(path_met, path_runoff, path_model_data, regine_main, time_vec, file_type) {
...
#' file_type <- "ncdf"
#' write_model_data(path_met, path_runoff, path_model_data, regine_main, time_vec, file_type)
#' update_model_data(path_met, path_runoff, path_model_data, overlap, file_type)
#' @export

update_model_data <- function(path_met, path_runoff, path_model_data, overlap, file_type) {
  ...
  if (file_type == "bil") {
    filetest <- paste(path_met, "/tm/", format(time_end_meteo, "%Y"), "/tm_", format(time_end_meteo, "%Y_%m_%d"), ".bil", sep = "")
  }
  ...
  res_new <- load_data_elev(path_met, path_runoff, regine_main, time_vec, file_type)
